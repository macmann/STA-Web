  ...
  return (
    ...
    >
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <form className="space-y-4 rounded-xl border border-steel/20 p-6" aria-label="Contact form" action="mailto:shin@sagasiaconsulting.com" method="post" encType="text/plain">
